...
public class Game
{
    ...
    Game(Board board, Pacman pacman, Ghosts ghostBlue)
    {
        this.board = board;
        this.pacman = pacman;
    ...
    public static int[] getPositionPacman()
    {
    ...
    public static void checkDeath(Pacman pacman, GhostBlue blue, GhostRed red, GhostPink pink, GhostYellow yellow)
    {
    ...
    public static void moveRandom(Ghosts ghost)
    {
        int[] dx, dy;
        dx = new int[4];
        dy = new int[4];
    ...
    public static boolean[] checkProximity(Ghosts ghost)
    {
